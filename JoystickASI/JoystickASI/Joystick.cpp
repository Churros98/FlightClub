...
HRESULT Joystick::GetInput(JoystickData* inputData) {
    ...
    inputData->power = MAX_DIRECTION_VALUE - joystickState.rglSlider[0]; // Bien mieux inversé
    ...
    inputData->reverseButton = joystickState.rgbButtons[11] ? true : false;
    inputData->airbreakButton = joystickState.rgbButtons[12] ? true : false;
